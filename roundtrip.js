...
__adroll._head().appendChild(rtb);
    ...
    if (__adroll.consent_allowed(__adroll.consent_networks.facebook)) {
        ...
        if (typeof __adroll.fb === 'undefined'){
            ...
            adrollFbqAsync(['init', '867127160068529']);

            adrollFbqAsync(['set', 'autoConfig', 'false', '867127160068529']);
            __adroll.fb=true;
            ...
            if (segment_type === "c") {
                ...
                if (!suppress_conversion) {
                    ...
                    var fb_track_src = "https://www.facebook.com/tr/?id=867127160068529" +
                                      "&ev=Purchase" +
